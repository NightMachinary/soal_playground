...
Another Difference between this part and the previous one is that we can show the integrations with other libraries in this part while it was not common in guide part.
